...
import com.example.cinepocket.ui.utils.ConnectivityObserver
...
class HomeViewModel(private val repo: MovieRepository,  connectivity: ConnectivityObserver) : ViewModel() {
    ...
    init {
        viewModelScope.launch {
            connectivity.isConnected.collect { ok ->
