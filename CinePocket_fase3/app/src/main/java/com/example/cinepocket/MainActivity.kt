...
import com.example.cinepocket.ui.utils.NetworkConnectivityObserver
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val connectivity = NetworkConnectivityObserver(applicationContext)
        val homeVm = HomeViewModel(repo, connectivity)
